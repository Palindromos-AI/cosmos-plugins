...
const CLI_SCRIPTS = [
  ...
  "plugins/cosmos-sources-tools/skills/dingding-fetch/scripts/publish-report.mjs",
  "plugins/cosmos-sources-tools/skills/dingding-fetch/scripts/repair-state.mjs",
  "plugins/cosmos-sources-tools/skills/feishu-fetch/scripts/publish-report.mjs",
  "plugins/cosmos-sources-tools/skills/feishu-fetch/scripts/repair-state.mjs",
